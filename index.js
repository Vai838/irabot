...
const vcard = 'BEGIN:VCARD\n' // ANAK ANJING MAU NGAPAIN?
            ...
            + 'TEL;type=CELL;type=VOICE;waid=:+62 853-4378-8098\n' // JANGAN KEK BABI SU
            + 'END:VCARD'
prefix = '.'
blocked = []
...
async function starts() {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["6285343788098@s.whatsapp.net"] // replace this with your number
			const adminbotnumber = ["6285343788098@s.whatsapp.net"]
			...
			case 'owner':
               ...
               case 'infogempa':
				...
				case 'setprefix':
					...
					if (!isOwner) return reply(mess.only.ownerB)
					prefix = args[0]
					reply(`Prefix berhasil di ubah menjadi tytd : ${prefix}`)
					break
		        //fitur adminbot
		        case 'setpp2':
                    if (!isGroup) return reply(mess.only.group)
